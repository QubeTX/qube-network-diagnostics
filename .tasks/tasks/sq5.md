...
- [ ] Controlled accuracy and cross-surface repeatability: paced payload accounting passes; additional hosted high-latency/upload and random-loss paired medians exceed 5%. The earlier harness used a debug Rust executable; an optimized release-build follow-up is running. All old evidence and the build-profile limitation are retained in canonical evidence/v5/README.md.
